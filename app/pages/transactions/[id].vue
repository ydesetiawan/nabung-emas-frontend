...
<template>
  <div class="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
    ...
    <BaseDeleteConfirmModal
      ...
      :message="`${t.transactions.deleteTransactionMessage} <span class='font-bold'>${transaction?.brand}</span> ${t.transactions.transactionOf} <span class='font-bold'>${transaction?.weight}g</span>.`"
      :confirm-text="t.transactions.deleteButton"
      :cancel-text="t.common.cancel"
      :is-deleting="isDeleting"
      :deleting-text="t.transactions.deleting"
