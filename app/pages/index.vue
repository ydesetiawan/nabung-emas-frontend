    ...
    <header class="sticky top-0 z-40 safe-top">
      ...
      <div class="relative flex items-center justify-between px-5 py-3">
        ...
        <div class="flex items-center gap-2">
          ...
          <!-- User Profile Icon -->
          <NuxtLink to="/profile" class="p-2.5 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-all active:scale-95">
            <Icon name="heroicons:user-circle" class="w-5 h-5 text-gray-600 dark:text-gray-400" />
          </NuxtLink>
